...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blogapp', '0002_rename_content_comment_text_alter_comment_author'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='blogpost',
            name='author',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='blog_posts', to='blogapp.user'),
        ),
    ]
